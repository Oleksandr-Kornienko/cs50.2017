...
def buy():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return apology("enter some symbol and shares")
        
        # if symbol is empty return apology
        if not symbol:
            return apology("enter an existing symbol")
            
        # if shares is empty
        if not shares or shares <= 0:
            return apology("enter shares and shares must be > 0")
...
def register():
    ...
    if request.method == "POST":
        ...
        # ensure password was submitted
            ...
            return apology("must enter password the same as confirm password")
...
def sell():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return apology("enter symbol and shares")
...
def changePassword():
    ...
    if request.method == 'POST':
        ...
        if not request.form.get("passwordConfirm"):
            return apology("enter password confirmation")
            
        # ensure password and confirmation match
        if request.form.get("newPassword") != request.form.get("passwordConfirm"):
...
@app.route("/alala", methods=["GET", "POST"])
def alala():
